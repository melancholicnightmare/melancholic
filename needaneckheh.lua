...
function ESP:Get_Tool(Player)
    ...
    if Character then
        local Tool = Character:FindFirstChild("Salvaged SMG") or Character:FindFirstChild("Wooden bow") or Character:FindFirstChild("Lighter") or Character:FindFirstChild("Salvaged Python") or Character:FindFirstChild("Salvaged P250") or Character:FindFirstChild("Salvaged AK74u") or Character:FindFirstChild("Boulder")
        if Tool then
            return Tool.Name
        end
    end
