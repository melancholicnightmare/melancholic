...
local ESP; ESP = {
    Settings = {
        ...
        Distance = {Enabled = false, Position = "Left", Color = Color3.new(1, 1, 1), Transparency = 0, OutlineColor = Color3.new(0, 0, 0)},
                ...
                if ESP.Settings.Enabled and On_Screen and Meter_Distance < ESP.Settings.Maximal_Distance and Good then
                    ...
                    elseif Health_Position == "Left" then
                        if Healthbar_Position == "Left" then
                            ...
                            Health.Position = Health_Left_Pos_Fill - Vector2.new(Health.TextBounds.X/2 - 2 + 15, -(100 * Health_Left_Size_Fill.Y / 100) + 2 - Left_Offset)
                        end
                        Left_Offset = Left_Offset + 10
